...
# import dagshub
# dagshub.init(repo_owner='suhasamane1101', repo_name='security_project', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric):
        """
        ✅ Logs metrics and model artifacts to MLflow without using mlflow.sklearn.log_model 
        (Dagshub doesn't support MLflow model registry endpoints).
        """
        with mlflow.start_run():
            # Log metrics
            ...
            # ✅ Save model temporarily and log as artifact
            with tempfile.TemporaryDirectory() as tmp_dir:
                temp_model_path = os.path.join(tmp_dir, "model.pkl")
    ...
    def train_model(self, X_train, y_train, x_test, y_test):
        ...
        # Evaluate all models and get best one
        ...
        # ✅ Persist final model.pkl (this is your own saved model)
        save_object("final_model/model.pkl", best_model)
